...
| 512 Bro/tunnel | Ska visa passage och rätt relation över/under andra objekt. | Egen 0,18 mm baslinje med böjda ändmarkeringar och 0,4 mm minimilängd finns. OSM-taggar genererar säkra kandidater; korsningar utan gemensam OSM-nod kan ge granskningskrävande riskförslag. Manuellt kan symbolen skapas genom val av två vägar eller dras helt fritt, och ändpunkterna kan förlängas över flera parallella stråk. | **Implementerad med automatisk, assisterad och fri geometri. Kartografisk granskning krävs för infererade överlappningar.** |
