...
const CACHE = 'omapmaker-shell-compass-heading-1';
const SHELL = ['index.html', 'field.html', 'home.js', 'home.css', 'app.mjs', 'styles.css', 'team.css', 'isom_symbols.js', 'isom_renderer.js'];
const MODULES = ['team_sync','team_home','team_panel','offline','viewport_layers','layer_presentation','contour_presentation','utils','generation_settings','indexeddb_store','map_setup','map_layer_api','generated_buildings','generated_paved_areas','generated_roads','generated_infrastructure','bridge_tunnel','generated_land_cover','magnetic_north','map_orientation','map_heading_control','heading_tracking','rotation_rendering','smooth_rotation','local_map_objects','map_objects','popup_stack','symbol_object_settings','field_survey','field_survey_panel','account_api'];
