export const MAP_ORIENTATION_MODES = ['map-north', 'magnetic-north', 'compass', 'heading-up', 'free'];
...
export function mapOrientationBearing(mode,declination=0,freeBearing=0) {
  ...
  if(mode==='heading-up'||mode==='compass')return Number(freeBearing||0);
...
export function mapOrientationLabel(mode) {
  ...
  if(mode==='compass')return 'Kompass';
