...
Never request, print, store, or commit Geotorget credentials. Do not commit
downloaded elevation data or generated caches. Keep the backend bound to
localhost when using a tunnel or reverse proxy. Before configuring public or
remote access, verify HTTPS and ask the user before exposing any new service.
