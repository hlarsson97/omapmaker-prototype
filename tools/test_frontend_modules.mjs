...
assert(fieldHtml.includes('type="module" src="app.mjs?v=52"'));
...
for (const versionedModule of ['map_layer_api.mjs?v=4','map_setup.mjs?v=5','account_api.mjs?v=3','generated_buildings.mjs?v=1','generated_roads.mjs?v=2','generated_infrastructure.mjs?v=15','bridge_tunnel.mjs?v=2','generated_land_cover.mjs?v=9','local_map_objects.mjs?v=3','map_objects.mjs?v=4','popup_stack.mjs?v=1','symbol_object_settings.mjs?v=9']) assert(appSource.includes(versionedModule), `${versionedModule} ska cachebrytas`);
