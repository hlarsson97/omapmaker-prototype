...
assert.deepEqual(centralLayerParameters('land-cover', {workspace: {scale: 15000}, symbolRegistryVersion: 6}), {importVersion: 13, source: 'automatic', printScale: 15000, symbolRegistryVersion: 6});
...
assert(fieldHtml.includes('type="module" src="app.mjs?v=57"'));
...
for (const versionedModule of ['map_layer_api.mjs?v=8','map_setup.mjs?v=6','account_api.mjs?v=3','generated_buildings.mjs?v=2','generated_roads.mjs?v=2','generated_infrastructure.mjs?v=16','bridge_tunnel.mjs?v=2','generated_land_cover.mjs?v=10','local_map_objects.mjs?v=3','map_objects.mjs?v=4','popup_stack.mjs?v=1','symbol_object_settings.mjs?v=9']) assert(appSource.includes(versionedModule), `${versionedModule} ska cachebrytas`);
