...
assert(fieldHtml.includes('isom_renderer.js?v=23'));
assert(fieldHtml.includes('@tomickigrzegorz/leaflet-rotate@0.2.4'));
assert(fieldHtml.includes('type="module" src="app.mjs?v=91"'));
